<script>
    ...
    function curaProtagonista() {
        ...
        if (Jogadora.hotDog <= 0) {
            narrador.innerHTML =
                " Ops, parece que o dinheiro de acabou, Hot Dog muito caro, meu parceiro.";
            ...
            if (Jogadora.hp >= 199) {
                narrador.innerHTML = "Vida cheia, mais 4 de Defesa.";
                Jogadora.Defesa += 4;
                Jogadora.hotDog--;
                ...
                narrador.innerHTML =
                    Jogadora.id + " Comprou o Hot Dog do meu parceiro.";
                Jogadora.HotDogJhon();
                Jogadora.hotDog--;
    ...
    function proximaFase() {
        ...
        Jogadora.certificadoRanieri = true;
...
<div id="tela">
    <div id="parteCima">
        <div id="texto">
            ...
            <div id="titulo2">O Código dá Vinte</div>
        </div>
        <div id="botaoInicar">
    ...
    <div id="batalha">
        ...
        <div id="d2">
            <div id="boss">
                ...
                <div id="bossImg">
                    <div id="bossSrc">
                        <img src="public/RanieriAB.png" alt="Ranieri" />
                    </div>
                </div>
            </div>
            <div id="falas">
