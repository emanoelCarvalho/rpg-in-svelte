<script>
    ...
    function ataqueProta() {
        ...
        if (dado6 <= 4) {
            narrador.innerHTML = Jogadora.id + " Atacou com chuva de  códigos.";
            Jogadora.ChuvaDeCodigos(lili);
            contadorAtq++;
    ...
    function bossAtaque() {
        ...
        if (dado6 <= 4) {
            ...
            narrador.innerHTML = lili.id + " Errou o ataque.";
        }
    ...
    function aleatorioAtaque() {
        ...
        if (dado12 <= 9) {
            ...
            narrador.innerHTML = lili.id + " Usou Arduíno ataque.";
            lili.Arduino(Jogadora);
        }
    }
    ...
    function ataqueProtaEspecial() {
        if (contadorAtq >= 4) {
            ...
            botaoAtt2.style.visibility = "hidden";
            botaoAtt3.style.visibility = "hidden";
            narrador.innerHTML = Jogadora.id + " Usou o ataque recursão.";
            Jogadora.Recursao(lili);
            contadorAtq = 0;
            ...
            narrador.innerHTML =
                Jogadora.id + " Não pode utilizar o ataque ainda.";
        }
    }
    ...
    function curaProtagonista() {
        ...
        if (Jogadora.cafe <= 0) {
            narrador.innerHTML =
                "Ops, parece que você utilizou todos os seus cafezinhos.";
    ...
    function proximaFase() {
        swal({
            title: "Aprovado!",
            text: "Você foi aprovado, parabéns.",
            icon: "success",
        });
        Jogadora.certificadoLili = true;
    ...
    function bossGanhouJogo() {
        swal({
            title: "Reprovado!",
            text: "Você foi reprovado, tente novamente.",
            icon: "error",
        });
...
<div id="tela">
    ...
    <div id="parteBaixo">
        <div>
            <button id="voltar1" on:click={() => trocarestadodojogo("jogar")}
                >Voltar</button
            >
        </div>
    </div>
...
<div id="telaB1">
    <div id="batalha">
        <div id="d1">
            ...
            <div id="luizaAtt">
                <div id="attFila1">
                    <div id="att1">
                        <button id="botaoAtt1" on:click={() => ataqueProta()}
                            >Chuva De Codigos</button
                        >
                    </div>
                    <div id="att2">
                        <button
                            id="botaoAtt2"
                            on:click={() => ataqueProtaEspecial()}
                            >Recursão</button
                        >
                    </div>
                </div>
        ...
        <div id="d2">
            <div id="boss">
                ...
                <div id="bossImg">
                    <div id="bossSrc">
                        <img src="public/LilianeLadoB1.png" alt="Liliane" />
                    </div>
                </div>
            </div>
            <div id="falas">
    ...
    <div id="botaoVoltar">
        <button id="voltar2" on:click={() => trocarestadodojogo("jogar")}
            >Voltar</button
        >
    </div>
</div>
